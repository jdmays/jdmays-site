    ...
    return (
      <div className="h-full mt-14 w-2/5 bg-purple-100 text-black">
        ...
        <section className="mx-8 px-8 space-y-4">
          ...
          <p className={"text-block"}>
            For those that pay attention to such things, this site is written in
            React and you can look at my, hopefully, good code at:
            https://github.com/jdmays (In the days ahead I will put add several
