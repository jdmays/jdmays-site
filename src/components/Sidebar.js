...
const Sidebar = () => {
  return (
    <div className="h-full mt-14 w-2/5 bg-purple-100 text-black">
      ...
      <h3 className="text-2xl mx-8 px-8 sm:px-4 sm:mx-4 font-bold text-black">Jim Mays</h3>
      ...
      <section className="mx-8 px-8 sm:px-4 sm:mx-4 md:px-4 md:mx-4 space-y-4">
        ...
        <a href={"/jim_mays_resume.pdf"}
          className="text-white bg-gradient-to-r from-purple-900 to-indigo-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
        >
          <FontAwesomeIcon icon={faFilePdf} size={"lg"} /> Download Resume
        </a>
        ...
        <ul className={"flex space-x-4 py-2 pt-8"}>
          ...
          <li className={"text-gray-600 flex items-center"}>
            ...
            <span className={"px-1"}>Written with React</span>
          </li>
        </ul>
