        ...
        <div className="bg-purple-100 text-gray-800 min-h-screen">
            <div className="container mx-auto py-10 px-5">
                ...
                <p className="text-lg text-gray-600 my-2">
                    In addition to the volunteers listed below, there are people from area churches in the community who
                    help by providing and serving the food. Without them, we wouldn't be able to do the Cafe.
                </p>
