    ...
    <div className="bg-purple-100 text-gray-800 min-h-screen">
      <div className="container mx-auto py-10 px-5">
        ...
        <div>
          ...
          <p className="text-md text-gray-600 my-2">
            When I'm not working I reside in Northern Illinois with my wife and
            two German Shepherd Dogs. We love spending time outside; hiking,
            kayaking or fixing things up around the house. One of my latest
            projects was a chicken coop which I have nicknamed the Chicken
            Palace due to its opulent construction. Those chickens sure have it good.
          </p>
